        ...
        <div>
          <StyledArticle>
            ...
            <Typography variant="body1" component="p">
              Our commitment to our client service is reflected in everything we
              do. Our team presents the best players with the best
              representation in addition, we provide elite footballers with top
              of the line marketing services and positioning our clients for
              proffesional football success through;
            </Typography>
          </StyledArticle>
          <StyledList>
            <li>
