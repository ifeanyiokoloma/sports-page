    ...
    <StyledContainer id="performance">
      <article>
        ...
        <Typography variant="body1" component="p">
          ...
          involving systematic observations to enhance performance and improve
          decision making primarily delivered through the provision of objective
          statistical and visual feedback. This is driven by a Sports needs to
          understand and improve tactics, technique and movement achieved
          through the delivery of real and lapsed time objective feedback.
        </Typography>
        <section>
          ...
          <Typography variant="body1" component="p">
            ...
            30% of their performance on the pitch correctly. This is where our
            team of experts comes in to play, with the remaining 70% by
            providing the facts of what happened which makes it a vital
          ...
          <Typography variant="body1" component="p">
            ...
            more evidence based decisions, augment the experiences and knowledge
            that they have gained and reduces the speculation to enhance their
          ...
          <Typography variant="body1" component="p">
            ...
            and data platforms such as the Dart Fish Video Analysis software for
            delivering pre competition intelligence through objective profiles
            of our athletes and the opposition strength and weakness to
            supporting the selection process with objective data.
          </Typography>
          <Typography variant="body1" component="p">
